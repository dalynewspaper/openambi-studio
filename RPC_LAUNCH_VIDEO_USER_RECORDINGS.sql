-- Replace RPCs to persist video_file_path on insert/update.
-- Run AFTER MIGRATION_USER_RECORDINGS_VIDEO.sql
-- WARNING: DROP CASCADE removes dependent grants; re-grant EXECUTE below.
-- If you have multiple insert_user_recording overloads, CASCADE clears them all — recreate only this signature.
...
-- Grants (adjust roles to match your project — often authenticated only)
...
-- Optional: remove anon execute if your older scripts granted it
